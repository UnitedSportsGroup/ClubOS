...
function App() {
  const [isRegisterSlug] = useRoute("/register/:slug");
  const [isRegisterIndex] = useRoute("/register");
  const isPublicPage = isRegisterSlug || isRegisterIndex;
      ...
      <TooltipProvider>
        {isPublicPage ? (
          <Switch>
            ...
            <Route path="/register" component={RegisterIndexPage} />
          </Switch>
        ) : (
          <AdminLayout />
        )}
